...
import static com.expleague.ml.binarization.partitions.BestPartitionsSearchers.bestPartitionWithMapper_veryFast_medianBest;
...
/**
 * Probability binarization with choosing best split from array of splits with closest score using median criteria
 */
public class ProbabilityGridWithMedianBest {
    /**
        ...
        for(int iters = 0; iters < binFactor; iters++) {
            for (int feature_index = 0; feature_index < dim; feature_index++) {
                ...
                for (int paired_feature_index = 0; paired_feature_index < dim; paired_feature_index++) {
                    ...
                    bestResult = bestPartitionWithMapper_veryFast_medianBest(binNumberMapper, feature, currentBorders.get(feature_index));
